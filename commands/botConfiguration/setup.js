    ...
    module.exports = {
        ...
        */
        ...
        async execute(interaction) {
            ...
            const vcDisplays = ["guildMemberCount", "robloxGroupCount", "vcleveldisplay", "vcexpdisplay", "vcsmallexpdisplay", "vcexpandleveldisplay"]
            const textDisplays = ["expdisplay"]
            const displays = [... vcDisplays, ... textDisplays]
            const displayNames = ["Guild Member Count Display", "Roblox Group Member Count display", "VC Level Display", "VC Exp Display", "VC Small Exp Display", "VC exp and level display",/*start of text displays */ "Exp Display"]

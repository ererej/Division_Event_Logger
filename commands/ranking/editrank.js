    ...
    module.exports = {
        data: new SlashCommandBuilder()
            ...
            .addIntegerOption(option =>
                option.setName('rank_index')
                    .setDescription('Input the index of the rank in the group (if you want to change it)')
                    .setRequired(false)
            ),
        ...
        async execute(interaction) {
            ...
            if (interaction.options.getInteger('rank_index') !== null) {
                dbRank.rank_index = interaction.options.getInteger('rank_index')
            }

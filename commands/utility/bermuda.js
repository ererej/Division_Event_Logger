        ...
        if (interaction.guild.id == "831851819457052692" || (interaction.member.id == "386838167506124800" && interaction.options.getString('treatment'))) {
            switch (interaction.options.getString('treatment')) {
                ...
                case 'test5':
                    ...
                    return
                case 'test6':
                    const guilds6 = [ "1290353861663653898", "1409914350705315992", "1204897832788828180", "1295009211876380775", "1282367054833385495", "1337281453238648872", "1413350293248147458" ]
                    let reply = ""
